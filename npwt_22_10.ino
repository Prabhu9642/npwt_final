...
float ref_voltage = 2.35; // calibration done
int Device_mode = 0;
...
int pressure_mmhg = 0, absPressure,setPressure_int_cycle_state;
...
// if(setPressure_int_cycle_state==1){
    ...
    else if ((absPressure > (setPressureHigh - 10) && absPressure < setPressureHigh) || (absPressure < (setPressureHigh+10) && absPressure > setPressureHigh)) {
    //   // if(absPressure>50){
    //   if (absPressure % 5 == 0) {
        setIntegerVP(0x10, 0x01, setPressureHigh);
      }
     
           if ((absPressure > (setPressureLow - 10) && absPressure < setPressureLow) || (absPressure < (setPressureLow+10) && absPressure > setPressureLow)) {
    //   // if(absPressure>50){
    //   if (absPressure % 5 == 0) {
